...
date: 2014-07-25
categories: tech
permalink: /2014/07/25/generating-sample-sitecore-analytics-data-with-jmeter/
---
...
That is a response header. You can see that the Sitecore analytics cookie is returned to your 'browser' (which is JMeter: 
...
In the second pre-processor script, **extract and set the cookie stored in the global scope**:
